...
# --- БЛОК ДЛЯ SQLMODEL ---
# 1. Загружаем .env, чтобы получить DATABASE_URL
load_dotenv()
...
# 4. Говорим Alembic, какие модели (таблицы) он должен отслеживать
target_metadata = SQLModel.metadata
# --- КОНЕЦ БЛОКА ---


# 5. Устанавливаем sqlalchemy.url из нашего .env файла
