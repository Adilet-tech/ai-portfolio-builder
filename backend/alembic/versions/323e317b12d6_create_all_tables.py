...
Revision ID: 323e317b12d6
Revises: 
Create Date: 2025-11-10 09:16:39.279373
...
def upgrade() -> None:
    ...
    sa.Column('generation_type', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('about_me', sqlmodel.sql.sqltypes.AutoString(length=2000), nullable=True),
    sa.Column('headline', sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True),
    ...
    sa.Column('template_id', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True),
    ...
    op.create_index(op.f('ix_portfolio_views_portfolio_id'), 'portfolio_views', ['portfolio_id'], unique=False)
